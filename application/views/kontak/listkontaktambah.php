    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <ul class="breadcrumb">
          ...
          <li><a href="#">Tambah Kontak</a><span class="divider-last">&nbsp;</span></li>
        </ul>
          ...
          <div class="span12">
            ...
            <div class="widget">
              <div class="widget-title">
                  <h4><i class="icon-reorder"></i>Tambah Data Kontak</h4>
                  <span class="tools">
              ...
              <div class="widget-body">
                ...
                <form action="<?=base_url()?>kontak/listkontakprosestambah" role="form" method="post" class="form-horizontal">
                  ...
                  <div class="control-group primary">
                    ...
                    <div class="controls">
                       <input type="text" class="span8"  required name="namapelanggan" placeholder="Input Nama Pelanggan" />
                       <span class="help-inline"></span>
                    </div>
                  </div> 
